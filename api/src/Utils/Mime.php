...
class Mime
{
    public static function findExtension($mime)
    {
        foreach (static::$mime_types as $ext => $types) {
            if (is_array($types)) {
    ...
    {
        return isset(static::$mime_types[$extension]) ? static::$mime_types[$extension] : null;
    }

    // Source on GIT GIST https://gist.github.com/nimasdj/801b0b1a50112ea6a997
    //
